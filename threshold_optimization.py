...
#print(h[u'阈值'][h[u'斜率指标']])
test=h[u'阈值'][h[u'斜率指标']]
outputfile = 'C:\\Users\\Administrator\\Desktop\\output.xls'
#test.to_excel(outputfile)

print(h[u'阈值'])
test2=h[u'阈值']
outputfile2 = 'C:\\Users\\Administrator\\Desktop\\output2.xls'
test2.to_excel(outputfile2)