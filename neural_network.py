...
inputfile1='C:\\Users\\Administrator\\Desktop\\UserHabitAnalysis\\data/train_neural_network_data.xls' #训练数据
inputfile2='C:\\Users\\Administrator\\Desktop\\UserHabitAnalysis\\data/test_neural_network_data.xls' #测试数据
testoutputfile = 'C:\\Users\\Administrator\\Desktop\\test_output_data.xls' #测试数据模型输出文件
...
model.fit(x_train, y_train, epochs = 10, batch_size = 1) #训练模型
model.save_weights('C:\\Users\\Administrator\\Desktop\\net.model') #保存模型参数
